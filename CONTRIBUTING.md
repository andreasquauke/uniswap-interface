...
Thank you for your interest in contributing to the Moonswap interface! 🦄
...
If a fix is urgently needed in production, releases can be manually triggered on [GitHub](https://github.com/Moonswap/uniswap-interface/actions/workflows/release.yaml)
...
[`good first issue`](https://github.com/Moonswap/uniswap-interface/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).

# Translations

Moonswap uses [Crowdin](https://crowdin.com/project/uniswap-interface) for managing translations. 
