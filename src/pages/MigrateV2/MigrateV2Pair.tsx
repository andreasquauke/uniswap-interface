        ...
        {chainId && migrator && (
          <ExternalLink href={getExplorerLink(chainId, migrator.address, ExplorerDataType.ADDRESS)}>
            <ThemedText.Blue display="inline">
              <Trans>Moonswap migration contract↗</Trans>
            </ThemedText.Blue>
          </ExternalLink>
        )}
        .
        ...
        <AutoColumn gap="lg">
          ...
          {noLiquidity && (
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              >
                <Trans>
                  You are the first liquidity provider for this Moonswap V3 pool. Your liquidity will migrate at the
          ...
          {largePriceDifference ? (
            <YellowCard>
              ...
              <ThemedText.Body fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <Trans>
                  You should only deposit liquidity into Moonswap V3 at a price you believe is correct. <br />
